...
class AppRouter {
  static final router = GoRouter(
    routes: [
      ...
      GoRoute(path: AppRoutePaths.root, builder: (context, state) =>  const Root()),
      GoRoute(path: AppRoutePaths.loginView, builder: (context, state) =>  const LoginView()),
      GoRoute(path: AppRoutePaths.signupView, builder: (context, state) =>  const SignupView()),
